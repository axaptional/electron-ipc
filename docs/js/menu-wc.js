...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">@axaptional/electron-ipc documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse" ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/Canceler.html" data-type="entity-link">Canceler</a>
                            </li>
                            <li class="link">
                                <a href="classes/Channels.html" data-type="entity-link">Channels</a>
                            </li>
                            <li class="link">
